---
name: lazysitter-rollback-agent
description: "LazySitter Tier 8 recovery. Triggered by monitor-agent on a regression signal. Has standing revert authority within the monitoring window — no extra approval needed."
