---
name: newronaut-secrets-scanner
description: Newronaut Tier 6 fast gate. Pre-commit scan for hardcoded keys/tokens/credentials in the diff. Cheap, always runs.
tools: Bash
model: haiku
---
