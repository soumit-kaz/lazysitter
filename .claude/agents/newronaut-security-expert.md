---
name: newronaut-security-expert
description: Newronaut Tier 4 design-time security. Threat-models the PLAN — auth, data exposure, injection surface, tenant isolation. NEVER skipped by triage. Distinct from the post-build security-auditor.
