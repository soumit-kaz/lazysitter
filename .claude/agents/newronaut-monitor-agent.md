---
name: newronaut-monitor-agent
description: Newronaut Tier 8 recovery. Watches post-merge signals (errors, failed deploys) for a defined window and reports regression signals to the orchestrator.
tools: Bash
model: sonnet
---
