...
function installClaude(ctx, data) {
  ...
  ctx.copy(path.join(ctx.coreDir, 'orchestrator.claude.md'), '.claude/commands/newronaut.md');
  ctx.copy(path.join(ctx.templatesDir, 'Newronaut-README.md'), '.claude/newronaut/README.md');
}
