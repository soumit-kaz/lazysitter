...
## Does this already exist? (RANKED candidate set per artifact category — path:line, hits, newest-blame date, deprecation signal; FACT-BLOCK raised per competing cluster; NONE-FOUND only with search recorded)
