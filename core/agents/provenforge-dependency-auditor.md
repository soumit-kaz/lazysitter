---
name: provenforge-dependency-auditor
description: Provenforge Tier 5 gate. Runs automatically whenever an implementer adds a new package — checks license compatibility and known vulnerabilities.
tools: Bash
model: sonnet
---
