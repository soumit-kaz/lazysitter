---
name: newronaut-code-reviewer
description: Newronaut Tier 6 verification. Diffs the implementation against the approved plan; runs lint/typecheck/build; flags drift from the approved design.
