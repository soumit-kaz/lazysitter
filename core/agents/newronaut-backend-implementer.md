---
name: newronaut-backend-implementer
description: Newronaut Tier 5 build. Writes server/data-layer code strictly against the approved plan. Runs in a sandboxed Bash environment.
