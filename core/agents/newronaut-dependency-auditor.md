---
name: newronaut-dependency-auditor
description: Newronaut Tier 5 gate. Runs automatically whenever an implementer adds a new package — checks license compatibility and known vulnerabilities.
tools: Bash
model: sonnet
---
