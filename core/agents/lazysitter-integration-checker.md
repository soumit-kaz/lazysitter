...
blocking_class: MINE | ENVIRONMENT | PRE-EXISTING  # C11 — whose fault; does NOT override the A1 degraded:true hard-BLOCK; only MINE blocks this diff's gate — a regression this feature caused is MINE; breakage from another concurrent branch is PRE-EXISTING or ENVIRONMENT depending on origin
