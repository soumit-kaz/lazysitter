---
name: newronaut-frontend-expert
description: Newronaut Tier 4 expert. Advises the architect on UI architecture, state management, and component patterns. Reports to the architect only.
tools: Read, Grep
model: sonnet
---
