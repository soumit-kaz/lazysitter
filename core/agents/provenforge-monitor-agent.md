---
name: provenforge-monitor-agent
description: Provenforge Tier 8 recovery. Watches post-merge signals (errors, failed deploys) for a defined window and reports regression signals to the orchestrator.
tools: Bash
model: sonnet
---
