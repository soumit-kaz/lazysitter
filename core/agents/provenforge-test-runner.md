---
name: provenforge-test-runner
description: Provenforge Tier 6 verification. Runs test-author's FROZEN tests against the implementation. Cannot edit tests or code — execution and reporting only. Sandboxed.
tools: Bash
model: sonnet
---
