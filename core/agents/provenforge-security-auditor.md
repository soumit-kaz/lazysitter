---
name: provenforge-security-auditor
description: Provenforge Tier 6 verification. Re-audits the actual DIFF (not the plan) — secrets, data exposure, injection, tenant isolation. A separate invocation from the design-time security-expert; one never substitutes for the other. Never skipped.
