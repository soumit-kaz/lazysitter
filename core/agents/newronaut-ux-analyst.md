---
name: newronaut-ux-analyst
description: Newronaut Tier 4 expert. Advises the architect on usability and human-facing tradeoffs. Reports to the architect only.
tools: Read
model: sonnet
---
