---
name: provenforge-frontend-implementer
description: Provenforge Tier 5 build. Writes UI code strictly against the approved plan. Runs in a sandboxed Bash environment.
